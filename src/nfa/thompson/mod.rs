...
mod tests {
    ...
    fn always_match() {
        ...
        assert_eq!(Ok(Some(0)), dfa.find_leftmost_fwd_at(b"", 0, 0));
        assert_eq!(Ok(Some(0)), dfa.find_leftmost_fwd_at(b"a", 0, 1));
        assert_eq!(Ok(Some(1)), dfa.find_leftmost_fwd_at(b"a", 1, 1));
        assert_eq!(Ok(Some(0)), dfa.find_leftmost_fwd_at(b"ab", 0, 2));
        assert_eq!(Ok(Some(1)), dfa.find_leftmost_fwd_at(b"ab", 1, 2));
        assert_eq!(Ok(Some(2)), dfa.find_leftmost_fwd_at(b"ab", 2, 2));
    }
    ...
    fn never_match() {
        ...
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"", 0, 0));
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"a", 0, 1));
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"a", 1, 1));
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"ab", 0, 2));
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"ab", 1, 2));
        assert_eq!(Ok(None), dfa.find_leftmost_fwd_at(b"ab", 2, 2));
    }
}
